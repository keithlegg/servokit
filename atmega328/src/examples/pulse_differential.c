...
#define MOTOR_ENABLE_PIN_P 0
#define MOTOR_ENABLE_PIN_N 1

#define MOTOR_PULSE_PORT PORTB
#define MOTOR_PULSE_PIN_P 2
#define MOTOR_PULSE_PIN_N 3

#define MOTOR_DIR_PORT PORTB
#define MOTOR_DIR_PIN_P 4
#define MOTOR_DIR_PIN_N 5
